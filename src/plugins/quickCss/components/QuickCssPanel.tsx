    ...
    return (
        <div className="flex-1 w-full h-full pl-4 pr-4 pb-32 md:pr-4 overflow-y-auto flex flex-col gap-4 min-h-full" style={{ display: isActive ? "flex" : "none" }} data-quickcss-panel>
            ...
            <textarea
                ...
                className="w-full flex-1 p-3 text-sm align-bottom bg-transparent focus:outline-none text-primary rounded-xl font-mono resize-none border border-border-l2"
